<template>
    <div>
        <el-container style="width: 100vw;height: 100vh;">
            <!-- 导航栏 -->
            <el-aside :width="!isCollapse ? '12vw' : '5vw'" :style="{
                transition: 'all 0.15s 0s linear',
            }">
                <!-- 菜单 -->
                <el-menu background-color="#545c64" active-text-color="#409EFF" default-active="0" text-color="#fff"
                    style="height: 100vh" class="el-menu-vertical-demo" :collapse="isCollapse">
                    <!-- 一级菜单 -->
                    <el-menu-item v-for="(item, index) in menuList" :key="index" :index="index.toString()"
                    ...
                    <!-- 二级菜单 -->
                    <el-sub-menu v-for="(item, index) in menuList" :key="index" :index="index.toString()"
