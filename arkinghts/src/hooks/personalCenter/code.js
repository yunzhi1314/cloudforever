import { mathCode } from "@/api/personalCenter/personalCenter/mathCode"; // 获取图形验证码请求的API
import { reactive, ref } from "vue";
import controlObj from "@/hooks/personalCenter/control"; // 导入按钮
import store from "@/store"; //引入仓库
import { telCode } from "@/api/personalCenter/personalCenter/telCode"; // 获取短信验证码请求的API
