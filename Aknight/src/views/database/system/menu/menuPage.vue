			...
			<el-col :span="7">
				<el-row class="nav">
					<el-input
						...
						placeholder="请输入查询内容"
						style="width: 60vw" />
					<el-button icon="search" type="primary" style="margin-left: 1vw"
						>查询</el-button
					>
					<el-button icon="FolderAdd" type="success">新增菜单</el-button>
				</el-row>
			</el-col>
		</el-row>
		<el-table :data="newData" style="margin-top: 3vh; height: 70vh" row-key="id">
			...
			<el-table-column label="操纵">
				<template #default="">
					<el-button
						type="text"
						size="small"
						style="font-size: 12px; margin: 0; width: 30%"
						>新增</el-button
					>
					<el-button
						type="text"
...
<script>
	...
	export default {
		...
		setup() {
			let Datalist = ref(
				JSON.parse(sessionStorage.getItem("medical")).basicMedical
			);
			let search = ref("");
