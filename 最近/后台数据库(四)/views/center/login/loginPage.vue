<template>
    ...
    <div class="loginBoard" :style='{
        ...
        <!-- 按钮区 -->
        <div class="btns">
            <section @click="toCode(controlObj, loginArr, resgisterElement[1])">
    ...
    <section class="change">
        ...
        <span @click="changeBoard(controlObj, false, loginArr.length > 2, loginArr)" :style='{
            color: controlObj.isChange ? "" : "#158FC5",
            fontSize: controlObj.isChange ? "" : "1.25rem",
        }'>登录</span>
        <span>·</span>
        <span @click="changeBoard(controlObj, true, loginArr.length < 4, loginArr, resgisterElement)" :style='{
            color: !controlObj.isChange ? "" : "#158FC5",
            fontSize: !controlObj.isChange ? "" : "1.25rem",
        }'>注册</span>
    </section>
