<template>
  <div class="changeBox">
    <section><span>更换实名信息</span></section>
    <div>
...
import { reactive,toRefs ,provide,watch,ref} from "vue";
// 调用请求函数，修改手机号
  ...
  setup() {
    ...
    const data = reactive([
      ...
      },
      {
        ...
        input: "输入身份证",
        value: "",
        zz:  /^([1-6][1-9]|50)\d{4}(18|19|20)\d{2}((0[1-9])|10|11|12)(([0-2][1-9])|10|20|30|31)\d{3}[0-9Xx]$/,
        isShow: false,
        tip: "*身份证格式不正确",
        tip1: "*身份证不能为空",
      },
    ...
    function confirmChange(){
      ...
      if(item.zz.test(item.value) &&  data[0].value != data[2].value){
    ...
    //调用请求函数
    changeMsg(url.personalCenter.changePersonalMsg.changeIdCard,personalMsg)
    }
